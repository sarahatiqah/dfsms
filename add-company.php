...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                                        data-feather="external-link"></i></span></span>Add Company</h4>
                    </div>
                    <!-- /Title -->
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <input type="text" class="form-control" id="input-1"
                                                        placeholder="Company" name="company" pattern="^\S.*$" required>
        ...
        <script>
            function addCompany() {
                var companyNameInput = document.getElementById("input-1");
                ...
                $.ajax({
                    url: 'backend/process_addCompany.php',
                    method: 'POST',
                    data: {
