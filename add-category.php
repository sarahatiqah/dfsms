    ...
    <body>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <input type="text" class="form-control" id="input-1"
                                                        placeholder="Category" name="category" pattern="^\S.*$" required>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <input type="text" class="form-control" id="input-2"
                                                        placeholder="Category Code" name="categorycode" pattern="^\S.*$"
                                                        required>
                                                    <div class="invalid-feedback">Please provide a valid category code.
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script>
            function addCategory() {
                var categoryNameInput = document.getElementById("input-1");
                var categoryName = categoryNameInput.value;

                var categoryCodeInput = document.getElementById("input-2");
                var categoryCode = categoryCodeInput.value;
                ...
                // Check if the category code is not empty after trimming
                if (categoryCode === "") {
