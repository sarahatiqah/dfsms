                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between mb-5">
                                                <div>
                                                    <span
                                                        class="d-block font-15 text-dark font-weight-500">Categories</span>
                                                </div>
                                                <div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between mb-5">
                                                <div>
                                                    <span class="d-block font-15 text-dark font-weight-500">Last 7 Days
                                                        Sales</span>
                                                </div>
                                                <div>
                                                </div>
                                            ...
                                            <div class="text-center">
                                                <span class="d-block display-4 text-dark mb-5">
                                                    <?php
                                                    // Check if $row['tt'] is not null before using number_format
                                                    if ($row['tt'] !== null) {
                                                        echo number_format($row['tt'], 2);
                                                    } else {
                                                        echo '0.00'; // Or any default value you want to display for null
                                                    }
                                                    ?>
                                                </span>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between mb-5">
                                                <div>
                                                    <span class="d-block font-15 text-dark font-weight-500">Yesterday
                                                        Sales</span>
                                                </div>
                                                <div>
                                                </div>
                                            ...
                                            <div class="text-center">
                                                <span class="d-block display-4 text-dark mb-5">
                                                    <?php
                                                    // Check if $rw['tt'] is not null before using number_format
                                                    if ($rw['tt'] !== null) {
                                                        echo number_format($rw['tt'], 2);
                                                    } else {
                                                        echo '0.00'; // Or any default value you want to display for null
                                                    }
                                                    ?>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between mb-5">
                                                <div>
                                                    <span class="d-block font-15 text-dark font-weight-500">Today's
                                                        Sales</span>
                                                </div>
                                                <div>
                                                </div>
                                            ...
                                            <div class="text-center">
                                                <span class="d-block display-4 text-dark mb-5">
                                                    <?php
                                                    // Check if $rws['tt'] is not null before using number_format
                                                    if ($rws['tt'] !== null) {
                                                        echo number_format($rws['tt'], 2);
                                                    } else {
                                                        echo '0.00'; // Or any default value you want to display for null
                                                    }
                                                    ?>
