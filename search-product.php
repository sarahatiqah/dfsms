        ...
        switch ($_GET["action"]) {
            ...
            case "add":
                if (!empty($_POST["quantity"])) {
                    ...
                    echo "<script>window.location.href='http://localhost/dfsms/search-product.php';</script>";
                    exit();
                                                ...
                                                foreach ($_SESSION["cart_item"] as $item) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                                if ($item['code'] === 'coupon') {
                                                                    echo '<a href="search-product.php?action=remove-coupon" class="btnRemoveAction"><img src="dist/img/icon-delete.png" alt="Remove Coupon" /><a/>';
                                                                } else {
